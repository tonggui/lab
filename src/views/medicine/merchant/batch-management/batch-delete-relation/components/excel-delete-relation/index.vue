...
<script>
  ...
  import { medicineExcel } from './constants'
  ...
  export default {
    ...
    props: {
      ...
      fetchExcelTemplate: {
        type: Function,
        default: fetchGetDeleteRelExcelTemplate
      },
      submitData: {
        type: Function,
        default: postBatchDelRelation

      }
    },
    data () {
      return {
        excelType: BATCH_EXCEL_TYPE.UPC,
        excelList: medicineExcel,
        BATCH_EXCEL_TYPE
      }
    },
    computed: {
