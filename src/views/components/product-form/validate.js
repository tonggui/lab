...
const skuValidator = (sku, whitelist, ignore) => {
...
export default (field, value, config, whitelist = {}) => {
  ...
  if (field === 'skuList') {
    skusValidator(value, whitelist, config.ignore || {})
    return
  }
