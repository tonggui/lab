    ...
    methods: {
      ...
      renderFooter (h) {
        ...
        if (this.$slots.footer) {
          ...
          const submit = <Button style="width: 120px" type="primary" onClick={this.handleConfirm} loading={this.submitting}>{ this.confirmText || (this.isEditMode ? '保存商品' : '确认发布商品') }</Button>
          const cancel = this.hideCancel ? null : <Button style="width: 120px" onClick={this.handleCancel}>{ this.cancelText || '取消' }</Button>
