...
const configs = [{
  ...
  data: [{
    ...
    name: '除价格、库存的信息',
    tip: {
      content: '适用场景：适用于商品价格、库存由分店设置的管理模式或价格、库存由系统对接更新的。选择此选项后，本次批量关联将总部与门店相同商品建立关联（相同UPC、店内码或商品标题认为是相同商品），仅更新商品基础信息，不更新价格、库存。\n' +
        '特殊说明：若分店无某一商品，关联成功后默认在分店新建此商品，该商品的价格为总部商品价格，库存为0。',
      transfer: true,
      'max-width': 300,
      placement: 'top'
    }
    ...
    tip: {
      content: '适用场景：适用于所有商品信息由分店自行管理的模式。选择此选项后本次批量关联仅将总部与门店相同商品建立关联（相同UPC、店内码或商品标题认为是相同商品），不会更新分店已有商品的所有信息（包括价格、库存）。\n' +
        '特殊说明：若分店无某一商品，关联成功后默认在分店新建此商品，该商品的价格为总部商品价格，库存为0。',
      transfer: true,
      'max-width': 300,
      placement: 'top'
