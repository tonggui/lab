...
/* https://km.sankuai.com/page/206554258 */
export const defaultWhiteListModuleMap = {
  propertyEditLock: false, // 根据“字段锁定”控制标品是否可编辑商品信息 配了 锁定 默认false
  weightNotEmpty: true, // 新建/编辑商品时，如果对应类目在“字段选填”中，则商品对应字段为选填，否则为必填
  upcNotEmpty: true, // 新建/编辑商品时，如果对应类目在“字段选填”中，则商品对应字段为选填，否则为必填
  ...
  informationLossWithPicture: true, // 当商品类目在对应配置结果中时，则对应商品不再信息不全中进行展示
