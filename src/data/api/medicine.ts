 ...
 */
export const getCategoryAttrs = ({ poiId, categoryId }, future = false) => httpClient.get('retail/r/getCategoryAttrAndValueList', {
  categoryId,
  wmPoiId: poiId
}).then(data => {
  data = data || {}
  return convertCategoryAttrList(data.attrAndValueList, { isMedicine: true, future })
})
