...
export const normalExcel = [{
      ...
      return (
        <div>
          ...
          <div>
            ...
            <a vOn:click={this.showModal} style={{ cursor: 'pointer', textDecoration: 'underline' }}>《美团商品库声明》</a>
          </div>
        </div>
      )
    }
  ...
  tip: ({
    render () {
      return <div>商品创建成功后，需编辑单个商品或使用批量操作补全商品信息。<span style={{ color: 'red' }}>必填信息填写完全后，商品才可上架售卖。</span></div>
    }
  })
}]
